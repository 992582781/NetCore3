...
namespace Common
{
    ...
    public static class EncryptUtil
    {
        ...
        /// <returns></returns>  
        public static string AesStr(this string value, string keyVal = "RongKang", string ivVal = "KangKang")
        {
            if (value == null)
            {
                throw new ArgumentNullException("未将对象引用设置到对象的实例。");
        ...
        /// <param name="ivVal">加密辅助向量</param>  
        /// <returns></returns>  
        public static string UnAesStr(this string value, string keyVal = "RongKang", string ivVal = "KangKang")
        {
            var encoding = Encoding.UTF8;
            byte[] btKey = keyVal.FormatByte(encoding);
            byte[] btIv = ivVal.FormatByte(encoding);
        ...
        /// <param name="ivVal">加密辅助向量</param>  
        /// <returns></returns>  
        public static byte[] AesByte(this byte[] data, string keyVal = "RongKang", string ivVal = "KangKang")
        {
        ...
        /// <param name="ivVal">加密辅助向量</param> 
        /// <returns></returns>  
        public static byte[] UnAesByte(this byte[] data, string keyVal = "RongKang", string ivVal = "KangKang")
        {
            byte[] bKey = new byte[32];
            Array.Copy(Encoding.UTF8.GetBytes(keyVal.PadRight(bKey.Length)), bKey, bKey.Length);
            byte[] bVector = new byte[16];
        ...
        /// DES 加密
        /// </summary>
        public static string Des(this string value, string keyVal = "RongKang", string ivVal = "KangKang")
        {
            try
            {
        ...
        /// DES 解密
        /// </summary>
        public static string UnDes(this string value, string keyVal = "RongKang", string ivVal = "KangKang")
        {
            try
            {
